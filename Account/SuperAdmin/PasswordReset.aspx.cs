...
namespace CyberApp_FIA.Account.SuperAdmin
{
    ...
    public partial class PasswordReset : Page
    {
        ...
        protected void BtnResetPassword_Click(object sender, EventArgs e)
        {
            ...
            // A valid password reset is an explicit recovery path during lockout.
        ...
        private static void SetOrCreateChildText(
            XmlDocument doc,
            XmlElement parent,
            string childName,
            string value)
